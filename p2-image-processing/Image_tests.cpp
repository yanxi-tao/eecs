...
TEST(test_image_init_from_stream) {
    ...
    ASSERT_EQUAL(p00.r, 255); ASSERT_EQUAL(p00.g, 0); ASSERT_EQUAL(p00.b, 0);
    ASSERT_EQUAL(p01.r, 0); ASSERT_EQUAL(p01.g, 255); ASSERT_EQUAL(p01.b, 0);
    ASSERT_EQUAL(p10.r, 0); ASSERT_EQUAL(p10.g, 0); ASSERT_EQUAL(p10.b, 255);
    ASSERT_EQUAL(p11.r, 255); ASSERT_EQUAL(p11.g, 255); ASSERT_EQUAL(p11.b, 255);
}
